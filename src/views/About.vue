<template>
  <div class="about">
    ...
    <h2>How to play</h2>
    <ul>
      <li>Pan the camera by holding left click and moving the mouse</li>
      <li>zoom out and in using your scroll wheel</li>
      <li>place blocks by right clicking, and left to remove</li>
    </ul>
